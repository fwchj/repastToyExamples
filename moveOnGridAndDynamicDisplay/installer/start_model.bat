@ECHO OFF
TITLE moveOnGridAndDynamicDisplay
...
CD moveOnGridAndDynamicDisplay

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./moveOnGridAndDynamicDisplay.rs
